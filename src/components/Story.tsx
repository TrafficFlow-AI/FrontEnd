...
export function Story() {
    return (
      <div className="">
        ...
        <h3 className="text-lg font-semibold mt-2 ">What are we trying to solve</h3>
        ...
        <h3 className="text-lg font-semibold mt-2 ">What we solve</h3>
        <p className="text-justify">
        ...
        <h2 className="text-3xl font-bold mt-8">Stack</h2>
